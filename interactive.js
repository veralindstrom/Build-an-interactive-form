...
// T-SHIRT DESIGN
$("#js-puns").hide();   //hide dropdown menu for "js puns"
$("#heart-js").hide();  //hide dropdown menu for "i <3 js"

$("#design").change ( function () {   //when user change option in the t-shirt design dropdown execute function below

	if($(this).val () == "js puns"){
    	$("#color").hide ();             //hide the first dropdown menu that tells you to "select a theme"
    	$("#heart-js").hide();
    	$("#js-puns").show();            //show the dropdown menu for the t-shirt design the user chose
	}

	else if ($(this).val () == "heart js"){   //same for the other shirt-design
		$("#color").hide();
		$("#js-puns").hide();
		$("#heart-js").show();
	}
